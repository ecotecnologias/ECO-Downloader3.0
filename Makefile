...
SOURCES = \
	__init__.py \
	ecodownloader.py ecodownloader_dialog.py

PLUGINNAME = ecodownloader

PY_FILES = \
	__init__.py \
	ecodownloader.py ecodownloader_dialog.py

UI_FILES = ecodownloader_dialog_base.ui
...
QGISDIR=C:\Users\ingri\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
